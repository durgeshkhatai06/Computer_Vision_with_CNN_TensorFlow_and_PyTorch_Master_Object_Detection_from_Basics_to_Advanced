...
# installed.
TCL_PREFIX='E:/Computer_Vision_with_CNN_TensorFlow_and_PyTorch_Master_Object_Detection_from_Basics_to_Advanced/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/Computer_Vision_with_CNN_TensorFlow_and_PyTorch_Master_Object_Detection_from_Basics_to_Advanced/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/Computer_Vision_with_CNN_TensorFlow_and_PyTorch_Master_Object_Detection_from_Basics_to_Advanced/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/Computer_Vision_with_CNN_TensorFlow_and_PyTorch_Master_Object_Detection_from_Basics_to_Advanced/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/Computer_Vision_with_CNN_TensorFlow_and_PyTorch_Master_Object_Detection_from_Basics_to_Advanced/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/Computer_Vision_with_CNN_TensorFlow_and_PyTorch_Master_Object_Detection_from_Basics_to_Advanced/venv\Library\lib\tclstub86.lib'
